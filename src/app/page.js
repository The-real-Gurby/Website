  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
    ...
    <div className="md:w-1/2 text-left text-white">
      ...
      <p className="text-white-700 mb-6">
        Hello! My name is Gurby I am curently a freshman In college studying CyberSecurity. I like to draw occasionally and I used to do 3d modeling but I couldn't bring my 3D printer to college with me so haven't done much.
         If you click the button below you can view some of my artworks!
      {/* Image on the right */}
      </p>
      </div>
<div className="md:w-1/2 flex justify-center bg-black relative z-10">
  <a
    href="/artwork"
...
<section className="bg-black w-full py-20 flex flex-col items-center">
  ...
  So, I've never made a website before. I've never coded in Javascript either, just Python so this whole thing is new to me! I've been having to look up how to do a lot of things because of this. I wanted to make a website so I would have something fun to do for at least a little while. College is stressful and I don't have many college friends so this is my outlet for things.
...
<section className="bg-black py-20 w-full flex flex-col items-center">
  ...
  <div className="flex flex-wrap gap-4 justify-center">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="bg-purple-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-purple-600 transition"
    >
